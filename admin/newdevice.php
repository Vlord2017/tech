...
<div class="empty">
	<div class="control-group">
			 ...
			 <div class="controls">
				  <select name="stdev_id" class="chzn-select" required/>
				    <option></option>
				      ...
				      <option value="<?php echo $row['stdev_id']; ?>"><?php echo $row['stdev_id']; ?><?php echo $row['stdev_location_name']; ?></option>
				    <?php } ?>
				   </select>
		    </div>
	</div>
	  ...
	  <div class="control-group"> 
		<div class="controls">
		<button  class="btn btn-primary" id="send" data-placement="right" title="Click to Assign"><i class="icon-share"> Assign Location</i></button>
