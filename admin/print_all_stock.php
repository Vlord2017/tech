...
font-family:"Times New Roman","serif"'>Powered by Code Warrior&trade; 2015</span></b></p>
...
$new = mysqli_query($conn,"select * from stdevice 
			   LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
			   where dev_status = 'Damage'")or die(mysql_error($conn));
$count = mysqli_num_rows($new);		                                               
?> 
...
<hr>
		<footer>
           <p>All Right Reserved T.R.I.S Powered by Code Warrior&trade; 2015</p>
        <footer>
</center>
</div>
</html>