            ...
            <div class="navbar-inner">
               <div class="container-fluid">
				 ...
				 <div class="navbar-header">
                    ...
                    <span  class="brand" href="#"></i><i class="icon-tasks"></i>  Panel Administrador</span>
				 </div>
				  <!--.nav-collapse -->
                    <div class="nav-collapse collapse">
						...
						?>
                            <li class="dropdown">
                                <a href="#" role="button" class="dropdown-toggle" data-toggle="dropdown"><img id="avatar1" class="img-responsive" src="<?php echo $row['adminthumbnails']; ?>">&nbsp;<?php echo utf8_encode($row['firstname']." ".$row['lastname']);  ?> <i class="caret"></i>
                                </a>
