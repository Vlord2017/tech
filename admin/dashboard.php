            ...
            <div class="col-lg-12">
                      <div class="alert alert-success alert-dismissable">
                         <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                          <img id="avatar1" class="img-responsive" src="<?php echo $user_row['adminthumbnails']; ?>"><strong> Bienvenido! <?php echo utf8_encode($user_row['firstname']." ".$user_row['lastname']);  ?></strong>
                      </div>
                    </div>
