            ...
            <div class="row-fluid">
			 <?php include('dashboard_slidebar.php'); ?>		
                <div class="span9" id="content">
                    <div class="row-fluid">
         	         <?php $query= mysqli_query($koneksidb,"select * from admin where admin_id = '$session_id'")or die(mysql_error());
...
<div id="page-wrapper">
        <?php 
	     $stocks = mysqli_query($koneksidb,"select * from stdevice
		...
		<?php 
	     $new = mysqli_query($koneksidb,"select * from stdevice
...
<div id="page-wrapper">
           <div class="row-fluid">
		 <?php 
	     $damage = mysqli_query($koneksidb,"select * from stdevice
	     LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		 where dev_status='Damage'")or die(mysqli_error($koneksidb));
		...
		<?php 
	     $Repaired = mysqli_query($koneksidb,"select * from stdevice
	     LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		 where dev_status='Repaired'")or die(mysqli_error($koneksidb));
...
<div id="page-wrapper">
           <div class="row-fluid">
        <?php 
	     $dump = mysqli_query($koneksidb,"select * from stdevice
	     LEFT JOIN device_name ON stdevice.dev_id=device_name.dev_id
		 where dev_status='Dump'")or die(mysqli_error($koneksidb));
		...
		<?php 
	     $location = mysqli_query($koneksidb,"select * from stlocation")or die(mysql_error($koneksidb));
